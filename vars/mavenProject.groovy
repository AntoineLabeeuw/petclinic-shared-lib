            ...
            stage('test') {
                ...
                post {
                    ...
                    failure {
                        ...
                        discordSend description: 'failure - Antoine', footer: '', image: '', link: '', result: '', thumbnail: '', title: 'failure', webhookURL: 'https://discordapp.com/api/webhooks/747819422705778738/dHWPHidlNLpiiKftWU84__Ss2LAkws77Swfdk5OWs22qla3hlI1B4zywW8ROg4nAwjRM'
                    }
                }
            }
        }
